...
def makeChange(coins, total):
    ...
    Returns:
        int: The minimum number of coins needed to make the total, or -1 if the total 
             cannot be met with the given denominations.
    ...
    - For the second example, it's not possible to make 1453 with the given coins, 
      so the result is -1.
    """
    if total == 0:
        return 0
    ...
    # If the total is achievable, return the number of coins, otherwise return -1
